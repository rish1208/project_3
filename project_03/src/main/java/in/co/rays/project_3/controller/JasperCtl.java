...
public class JasperCtl extends BaseCtl {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			 ...
			 * .compileReport(rb.getString("user")+rb.getString("jasper"));
			 * 
			 */
			...
			/*
			 * HttpSession session = request.getSession(true); UserDTO dto = (UserDTO)
			 * session.getAttribute("user"); dto.getFirstName(); dto.getLastName();
			 */
