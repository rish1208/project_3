...
public final class ModelFactory {
	...
	public ProductModelInt getProductModel() {
		...
		if (ProductModel == null) {
			...
			if ("JDBC".equals(DATABASE)) {
				ProductModel = new ProductModelJDBCImp();
			}
	...
	public LoneModelInt getLoneModel() {
		LoneModelInt LoneModel = (LoneModelInt) modelCache.get("LoneModel");
		if (LoneModel == null) {
			if ("Hibernate".equals(DATABASE)) {
				LoneModel = new LoneModelHibImp();
			}
			if ("JDBC".equals(DATABASE)) {
				LoneModel = new LoneModelJDBCImp();
			}
			modelCache.put("LoneModel", LoneModel);
		}
	...
	public VehicleModelInt getVehicleModel() {
		...
		if (VehicleModel == null) {
			...
			if ("JDBC".equals(DATABASE)) {
				VehicleModel = new VehicleModelJDBCHibImp();
			}
